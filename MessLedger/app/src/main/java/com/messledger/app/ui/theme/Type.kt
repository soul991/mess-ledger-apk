...
// ── Font families matching index.html's --font-display / --font-body / --font-mono ──

val ZillaSlabFamily = FontFamily(
...
// ── Typography ──────────────────────────────────────────────────────────────
// display/headline → Zilla Slab (--font-display, applied via h1/h2/h3 selector)
// body/title/label → IBM Plex Sans (--font-body, the page default)
// Mono (amounts, dates) is used directly via IbmPlexMonoFamily in composables.
